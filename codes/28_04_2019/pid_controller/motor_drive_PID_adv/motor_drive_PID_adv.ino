...
void loop()
{
  ...
  p_time = t;
  // ********************
  Kp = 0.14 ; // Feedback gains (proportional) , ilk çalışan=0.15,16 , hizli=19, gün sonu=18 , uzunvid=19,205, bidön=18 , cp1=145
  Kd = 0.05 ; // Feedback gains (delta) , ilk çalışan=0.11 , hizli=0.12 , gün sonu=13 , uzunvid=158,165, bidön=13 , cp1=1325,124,126
  Ki = 0 ; // Feedback gains (sum) , ilk çalışan=0.06 , hizli=0.075 ,gün sonu=06 , uzunvid= 058,615, bidön=06 , cp1=02
  // ********************
