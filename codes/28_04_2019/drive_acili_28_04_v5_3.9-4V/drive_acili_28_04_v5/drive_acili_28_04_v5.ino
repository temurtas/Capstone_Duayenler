...
void loop()
{
  ...
  p_time = t;
  // ********************
  Kp = 0.1893; // Feedback gains (proportional) , ilk çalışan=0.15,16 , hizli=19, gün sonu=18 , uzunvid=19,205, bidön=18 , cp1=145, cp3=1453
  Kd = 0.155 ; // Feedback gains (delta) , ilk çalışan=0.11 , hizli=0.12 , gün sonu=13 , uzunvid=158,165, bidön=13 , cp1=1325,124,126, cp3=1345
