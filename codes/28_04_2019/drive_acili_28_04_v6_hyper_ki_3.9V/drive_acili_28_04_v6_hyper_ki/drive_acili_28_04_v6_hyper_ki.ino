...
void loop()
{
  ...
  Ki = 1.0 ; // Feedback gains (sum) , ilk çalışan=0.06 , hizli=0.075 ,gün sonu=06 , uzunvid= 058,615, bidön=06 , cp1=02, cp3=028
  // ********************
  ...
  if (stop_state == 1) {
    ...
    analogWrite(left_motor_pwm, 0 ) ;
      ...
      if(yon == 0){
        ...
        pwm_offset = max ( 62 - 1.88 * beta , Kmin2) ; // 29,25 , hizli=36,0.7,25,26 , gün sonu=39,.7,29, uzunvid=60,1.78,30-61,1.76,30, bidön=54,1.575,30
