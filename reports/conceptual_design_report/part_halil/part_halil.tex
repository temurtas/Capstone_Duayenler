...
for (lines_is_valid)	
	...
	\end{figure}
	\paragraph{Alternatve Solutions for Data Processing Subsystem}
...
<<<<<<<	\begin{lstlisting}[language=Python,float=b,numbers=left,frame=single,caption=Serial object decleration in Python,label=sc:serial_python, captionpos=b ] 
import serial
...
RS232_OpenComport(cport_nr, bdrate, mode)
	...
	\todo{EDIT BUYUKTUR KUCUKTUR ISARETLERIIIIIIIII}
