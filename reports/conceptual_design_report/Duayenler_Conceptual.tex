...
minLineLength=30, maxLineGap=40);
	...
	\paragraph{Vehicle Detection Subsystem Tests}
		...
		\subparagraph{Front Vehicle Detection Test in Closed Environment}
		...
		\subparagraph{Rear Vehicle Detection Test in Closed Environment}
		...
		\subparagraph{Angled Approach Test}
		...
		\subparagraph{Vehicle Detection in Different Sunlight Conditions Test}
			...
			\begin{enumerate}
				\item Repeat the test steps of the \textit{Front Vehicle Detection Test in Closed Environment} in CCC (KKM) ground under direct sunlight
				\item Repeat step 1 in CCC (KKM) under artificial light, in other words, under no direct sunlight conditions
...
for (lines_is_valid)	
	...
	\paragraph{PID Controller Subsystem Tests}	
		\subparagraph{PID Parameters Test for Given Input}
		...
		\subparagraph{Path Tracking Test}
		...
		\subparagraph{Tracking a Path with Obstacles Test}
		...
		\subparagraph{Path Tracking Test with Physical Disturbances}
...
<<<<<<< HEAD
		...
		\subparagraph{Raspberry Pi as Client Test}
			...
			\end{enumerate}		
		\subparagraph{Raspberry Pi as Server Test}
			This test aims to validate whether the Raspberry Pi can successfully fulfil the requirements set by \textit{Handshake protocol} as a client.Test procedure is as follows:
			\begin{enumerate}
...
=======
	...
	The codes that were written in Python were tested in 3 different combinations.These are:
	\begin{itemize}
		\item Test on the same computer (or Raspberry Pi) using it both as server and as client
		\item Test on two computers
		\item Test on a computer and a Raspberry Pi
	\end{itemize}
	
	
>>>>>>> 73f80804190314d6571d1424496b41babcb574ff
	...
	\paragraph{Direction Subsystem Tests}
		\subparagraph{Straight Drive Test}
		...
		\subparagraph{Circular Drive Test}
