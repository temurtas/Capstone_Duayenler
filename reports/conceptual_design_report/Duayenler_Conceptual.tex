...
for (lines_is_valid)	
	...
	\paragraph{PID Controller Subsystem Tests}	
		...
		\subparagraph{Path Tracking Test}
			...
			\begin{enumerate}
				\item Make the necessary connection between motors Arduino and data processing unit \vspace{-0.7cm}
...
RS232_OpenComport(cport_nr, bdrate, mode);
	...
	\paragraph{Direction Subsystem Tests}
		\subparagraph{Straight Drive Test}
			...
			\begin{enumerate}
				\item Make the necessary connections between motors, motor controller and the Arduino \vspace{-0.7cm}
				\item 
			\end{enumerate}
