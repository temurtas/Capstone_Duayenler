...
\begin{itemize}
	 ...
	 \item Step up and step down converters are imported to the system. However, they burnt out.
	 \item Vehicle drive with controller is tested. Some of problems were: PWM output of pins were not identical, small PWM difference yielded big voltage difference in motor drivers. This problem took a long time to fix.
...
\section{Plans}
\begin{itemize}
\item PID controller design parameter tuning.
