...
\section{Module Demo Implementations}

	\begin{itemize}
		\item The result of the lane detection algorithm will be presented.
		\item The Handshake Protocol will be presented.		
	\end{itemize}
