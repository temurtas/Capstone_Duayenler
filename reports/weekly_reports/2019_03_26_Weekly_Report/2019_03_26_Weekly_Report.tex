...
\begin{itemize}
	 ...
	 \item Some problems in lane detection algorithm were noticed. Possible solutions were discussed.
...
%	\center
%	\setlength{\unitlength}{\textwidth} 
%	\includegraphics[width=0.6\unitlength]{photo5776198910077939979}
%	\caption{\label{fig:photo5776198910077939979} As Chassis is being Assembled. }
%\end{figure}
