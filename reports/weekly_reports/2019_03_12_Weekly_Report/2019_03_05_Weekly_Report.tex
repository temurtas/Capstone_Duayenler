...
\vspace*{-1.7cm}
\begin{center}
	\Large\textbf{March 05 - March 11 Weekly Report}
	\end{center}
\section{Progress}
\begin{itemize}
 
	 \item Critical Design Review Report is written.
	 \item Assembling of new chassis is done.
	 \item "Estimation with Confidence Interval" is studied to be integrated into image processing.
