...
\subsubsection{PID Controller Subsystem}\label{sect:ControllerSubsystem}
	...
	\todo{This subsubsection was rewritten for final report}
	\begin{enumerate}
		\item {Requirements for the Solution}
...
%$$\boxed{ G_p(s)=\frac{T(s)}{G_c(s)-T(s)G_c(s)} }$$ 
	...
	Other than the modelling part, the proposed methods are same as the ones proposed in the conceptual design review report and works as exected. 
...
\section{Other Considerations}
	...
	%Cost anaysis for the project can be investigated at \textit{Table~\ref{tab:cost}}. The reproducible vehicle is expected to cost under 200 dollar as desired by the project requirements.
	...
	\begin{table}[H]
		...
		\label{tab:cost}
	\end{table}
	\todo{this table was recreated for the final report, please do thereal spendings}
