...
\usepackage[toc]{appendix} %appendix package
\usepackage{xcolor}
\usepackage{listings}
\usepackage{xspace}
\usepackage{amssymb}
...
Time table for the tasks including the assignment of responsibilities until the submission of the proposal report\todo{TIMETABLEEEEEEEEEEEEEEEE}

\begin{appendices}
	%%%%%%%		Figure Numbering Redefine		%%%%%%%
...
\includepdf[pages=1-2, scale=1.0 ]{../../company/personal-data/CVs/Sarper_CV}
\includepdf[pages=1-2, scale=1.0 ]{../../company/personal-data/CVs/Enes_CV}
\includepdf[pages=1-2, scale=1.0 ]{../../company/personal-data/CVs/Erdem_CV}
\includepdf[pages=1-2, scale=1.0 ]{../../company/personal-data/CVs/Halil_CV}
\includepdf[pages=1, scale=1.0 ]{../../company/personal-data/CVs/Ilker_CV}
