...
\begin{itemize}
	...
	\end{figure}
\item {[Team]} The project to be realized is determined according to the criteria listed in objective tree. The results are presented in {Figure~\ref{fig:objective-tree}}.
