...
\begin{figure}[b!]
	...
	\caption{\label{fig:project_evaluation} Project Evaluation.}
\end{figure}
\begin{itemize}
...
\item {[Team]} The project to be realized is determined according to the criteria listed in objective tree. The chosen project is "Chasing Cars in an Elliptic Path". The results are presented in {Figure~\ref{fig:objective-tree}}. Points are as follows:
\begin{itemize}
...
\item {[Team]} Progressed in proposal report. Systems and sub-systems of the project are determined.
\begin{figure}[h!]
	\centering
	\setlength{\unitlength}{\textwidth} 
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{project-systems}
	\caption{\label{fig:project-systems} Project Systems.}
\end{figure} 
