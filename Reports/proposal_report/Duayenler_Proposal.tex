...
\section{Requirement Analysis}
	...
	\begin{figure}[H]
		...
		\caption{\label{fig:objective_tree}Pairwise Comparison Charts}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{objective-tree/objective_tree} 
	...
	\begin{figure}[H]
		...
		\caption{\label{fig:sub_objective_tree}Project Objective Tree}
	\end{figure}
